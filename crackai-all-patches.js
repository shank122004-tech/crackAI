...
(function () {
  ...
  async function verifyPremiumServer(forceRefresh) {
    ...
    try {
      ...
      console.warn('[CrackAI Security] Premium verify failed, using cache:', e.message);
      return _verifyCache || { isPremium: false };
    }
  }
  ...
  console.info('[CrackAI] Security v1.0 — server-side premium verification active');
})();
