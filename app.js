...
async function _syncFirestoreBackground(fbUser) {
  ...
  try {
    ...
    if (snap.exists()) {
      ...
      // Update lastSeen on every login so admin dashboard shows real activity
  ...
  modal.innerHTML = `
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
      ...
      <div style="background:rgba(16,185,129,0.05);border:1.5px solid rgba(16,185,129,0.30);border-radius:16px;padding:18px;position:relative;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:14px;">
          ...
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📄</span> <b>5 PDF uploads/day</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🤖</span> All AI models (Pro + V4)</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📚</span> Class 1–12 CBSE/NCERT</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>⚡</span> Priority AI responses</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🔒</span> No daily question limit</div>
        </div>
    ...
    <div style="background:rgba(239,68,68,0.06);border:1px solid rgba(239,68,68,0.18);border-radius:12px;padding:12px 14px;margin-top:12px;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;font-size:11px;color:rgba(200,195,255,0.50);">
        ...
        <div>❌ All class modes (1-12)</div><div>❌ V4 Pro model access</div>
      </div>
      <div style="font-size:11px;color:rgba(255,200,150,0.80);margin-top:9px;font-weight:600;text-align:center;">💡 SSC Pro from ₹199/mo · Class Pro from ₹129/mo · Cancel anytime</div>
    </div>
